...
const Contact = () => {
  return (
    <section
      id="contact"
      className="py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white"
    >
        ...
        <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:aripilli.bhavanaa@gmail.com"
                    className="text-gray-300 hover:text-white transition-colors"
                  >
                    aripilli.bhavanaa@gmail.com
                  </a>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl p-8 backdrop-blur-sm border border-gray-600 shadow-2xl">
            ...
            <div className="space-y-6">
              {/* View Resume Button */}
              <a
                href="public/ARIPILLI BHAVANA.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center space-x-3 bg-gradient-to-r from-gray-700 to-gray-600 hover:from-gray-600 hover:to-gray-500 text-white py-4 px-6 rounded-xl transition-all duration-200 font-medium shadow-lg border border-gray-600"
              >
                <Download size={20} />
